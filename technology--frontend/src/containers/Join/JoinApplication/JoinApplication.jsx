...
const JoinApplication = () => {
  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      try {
        const responseAll = await axios.get(`${import.meta.env.VITE_REACT_APP_API}/api/visit/jobapplication/`);
  ...
  return (
    <div className='job-application'>
      ...
      <div className="job-application-row">
        {jobaplicationstep.map((step,index) => (
          <div className="job-application-col" key={index}>
