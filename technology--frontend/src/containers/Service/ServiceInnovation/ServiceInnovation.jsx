          ...
          <div className='service-innovation'>
               ...
               <div className="service-innovation-row js-scroll fade-in fade-in-bottom">
                    <div className="service-innovation-col">
                         ...
                         <h3>Keep learning</h3>
                         <p>We believe every innovation cycle begins with better understanding your business, its goals, and your user’ problems. We use techniques that allow us to identify, design, and validate solutions as quickly as possible.</p>
                    </div>
                    <div className="service-innovation-col">
